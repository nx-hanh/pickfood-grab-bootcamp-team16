...
export default async function Page() {
  ...
  return (
    <main className="min-h-svh w-full bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-1 md:space-y-6 bg-white bg-opacity-90 p-6 rounded-xl shadow-2xl">
        <div className="text-center">
          <h1 className="text-2xl md:text-4xl font-extrabold text-gray-900 mb-2">
            Welcome to PickFood
          </h1>
          <p className="text-md md:text-xl text-gray-600 mb-6">
