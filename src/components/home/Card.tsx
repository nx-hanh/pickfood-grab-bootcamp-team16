      ...
      <div className="flex flex-col p-4 h-fit ">
        ...
        <div className="grid grid-cols-10 gap-2 grid-rows-4">
          ...
          <Image
            ...
            width={0}
            className={`${
              distance === -1 ? "row-start-3" : "row-start-4"
            } row-span-1  col-span-1 object-cover w-full h-full max-h-[25px] max-w-[25px] `}
          />
          <p
            className={`${
              distance === -1 ? "row-start-3" : "row-start-4"
            } row-span-1  col-start-2 col-span-9 text-lg w-full line-clamp-1`}
          >
            {priceInFormatted}
          </p>
        </div>
