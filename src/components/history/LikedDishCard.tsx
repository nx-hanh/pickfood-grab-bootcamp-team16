...
const LikedDishCard: FC<LikedDishCardProps> = ({ dish }) => {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="bg-white w-full flex items-center justify-center ">
        <div className="w-full max-w-screen-md ">
          ...
          <div className="p-4 pb-0 w-full flex flex-row justify-center items-center">
            ...
            <div className="flex-1 h-[100px] flex flex-col items-start justify-start ml-2">
              <div
                className="px-2 w-full bg-[#eef0ee] rounded-[10px] cursor-pointer select-none
              ...
              >
                <span className="w-full flex flex-col justify-center items-center h-full text-center text-black font-semibold text-lg ">
                  {dish.address}
                </span>
              </div>
              <span className="text-md text-black ml-2">
                Giá: {priceInFormatted}
              </span>
            </div>
          </div>
